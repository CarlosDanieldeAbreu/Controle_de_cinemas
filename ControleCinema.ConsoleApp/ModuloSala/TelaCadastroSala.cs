...
namespace ControleCinema.ConsoleApp.ModuloSala
{
    public class TelaCadastroSala : TelaBase, ITelaCadastravel
    {
        ...
        public void Excluir()
        {
            ...
            bool temSalaRegistradas = VisualizarRegistros("Pesquisando");

            if (temSalaRegistradas == false)
            {
        ...
        {
            Console.WriteLine("Digite o número de assentos disponiveis: ");
            int numeroAssentos = int.Parse(Console.ReadLine());
            Console.WriteLine("Digite a capaciddeda: ");
